...
const ContactUs = () => {
  return (
    <div className="container mx-auto py-10 px-4">
      ...
      <div className="flex flex-wrap md:flex-nowrap justify-between items-start gap-16"> {/* Added flex-nowrap for non-wrapping */}
        {/* Contact Form */}
        <div className="w-full md:w-1/3 min-w-[300px]"> {/* One-third width and min width for form */}
          <h1 className="font-semibold text-3xl mb-4">CONTACT US</h1>
          <p className="text-lg mb-6">Ask Us Anything - We’d Love to Hear from You!</p>
        ...
        {/* Google Map Embed */}
        <div className="w-full md:w-2/3 min-w-[400px]"> {/* Two-thirds width and min width for map */}
          <iframe
